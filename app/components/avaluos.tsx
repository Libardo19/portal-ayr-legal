    ...
    const counters: CounterData[] = [
        { target: 350, suffix: "+", label: "Avalúos emitidos"     },
        { target: 13,  suffix: "",  label: "Categorías cubiertas" },
    ...
    export default function Avaluos() {
        return (
        <section id="avaluos" className="bg-[#060f1a] overflow-hidden relative">
            ...
            <div className="flex mt-12 animate-[fadeUp_0.6s_1.3s_both]">
                {counters.map((c, i) => (
                <Counter key={i} target={c.target} suffix={c.suffix} label={c.label} delay={1400 + i * 200} />
                ))}
            </div>
            </div>
            ...
            <div className="relative z-10 px-14 max-w-[1120px] mx-auto">
            ...
            <div className="relative z-10 flex items-center justify-between px-14 py-8 border-t border-[#c9a84c]/10 max-w-[1120px] mx-auto gap-6" style={{ animation: "fadeUp 0.5s 2.7s both" }}>
            <div className="flex items-center gap-4">
                <span className="font-mono text-[11px] text-[#4a6a8a] tracking-[1px]">→ siguiente paso</span>
                <span className="text-[18px] font-semibold text-[#e8f0f8]">¿Necesita un avalúo certificado?</span>
            </div>
            <div className="flex gap-3 shrink-0">
                <button className="bg-[#c9a84c] text-[#060f1a] text-[12px] font-bold tracking-[1.5px] uppercase px-7 py-3 rounded-md">Solicitar Avalúo</button>
                <button className="bg-transparent text-[#c9a84c] text-[12px] font-bold tracking-[1.5px] uppercase px-7 py-3 rounded-md border border-[#c9a84c]/30">Ver Categorías</button>
            </div>
            </div>
