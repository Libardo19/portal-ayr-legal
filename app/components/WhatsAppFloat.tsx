    ...
    return (
        ...
        {/* Tooltip */}
        <span
            className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-white text-xs font-medium px-3 py-1.5 rounded-lg whitespace-nowrap shadow-lg"
            style={{ background: '#0a2342', border: '1px solid rgba(201,169,97,0.2)' }}
        >
            Solicitar Asesoría
        </span>
